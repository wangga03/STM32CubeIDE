#ifndef _ROS_krsbi2025_Actuator_h
#define _ROS_krsbi2025_Actuator_h
  ...
  class Actuator : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (u_thruster_8.base >> (8 * 3)) & 0xFF;
      ...
      u_thruster_9.real = this->thruster_9;
      *(outbuffer + offset + 0) = (u_thruster_9.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_thruster_9.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_thruster_9.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_thruster_9.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->thruster_9);
      union {
        float real;
        uint32_t base;
      } u_thruster_10;
      u_thruster_10.real = this->thruster_10;
      *(outbuffer + offset + 0) = (u_thruster_10.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_thruster_10.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_thruster_10.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_thruster_10.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->thruster_10);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_thruster_9.base = 0;
      u_thruster_9.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_thruster_9.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_thruster_9.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_thruster_9.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->thruster_9 = u_thruster_9.real;
      offset += sizeof(this->thruster_9);
      union {
        float real;
        uint32_t base;
      } u_thruster_10;
      u_thruster_10.base = 0;
      u_thruster_10.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_thruster_10.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_thruster_10.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_thruster_10.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->thruster_10 = u_thruster_10.real;
      offset += sizeof(this->thruster_10);
     return offset;
    }

    virtual const char * getType() override { return "krsbi2025/Actuator"; };
    virtual const char * getMD5() override { return "73a6109e0e969f8e11165c5ede486575"; };
