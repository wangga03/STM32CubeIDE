#ifndef _ROS_rostu_sas_BallPositionBasedOnCamera_h
#define _ROS_rostu_sas_BallPositionBasedOnCamera_h
...
namespace rostu_sas
{
  ...
  class BallPositionBasedOnCamera : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rostu_sas/BallPositionBasedOnCamera"; };
