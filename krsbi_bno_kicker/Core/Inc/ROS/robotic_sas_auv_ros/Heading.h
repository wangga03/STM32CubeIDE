#ifndef _ROS_robotic_sas_auv_ros_Heading_h
#define _ROS_robotic_sas_auv_ros_Heading_h
...
namespace robotic_sas_auv_ros
{
  ...
  class Heading : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robotic_sas_auv_ros/Heading"; };
