#ifndef _ROS_krsbi_2025_BallPositionBasedOnCamera_h
#define _ROS_krsbi_2025_BallPositionBasedOnCamera_h
...
namespace krsbi_2025
{
  ...
  class BallPositionBasedOnCamera : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "krsbi_2025/BallPositionBasedOnCamera"; };
