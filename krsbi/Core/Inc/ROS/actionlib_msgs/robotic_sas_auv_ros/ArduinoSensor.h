#ifndef _ROS_robotic_sas_auv_ros_ArduinoSensor_h
#define _ROS_robotic_sas_auv_ros_ArduinoSensor_h
...
namespace robotic_sas_auv_ros
{
  ...
  class ArduinoSensor : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robotic_sas_auv_ros/ArduinoSensor"; };
