#ifndef _ROS_robotic_sas_auv_ros_IsStable_h
#define _ROS_robotic_sas_auv_ros_IsStable_h
...
namespace robotic_sas_auv_ros
{
  ...
  class IsStable : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robotic_sas_auv_ros/IsStable"; };
