#ifndef _ROS_robotic_sas_auv_ros_SetPoint_h
#define _ROS_robotic_sas_auv_ros_SetPoint_h
  ...
  class SetPoint : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (u_pos_x.base >> (8 * 3)) & 0xFF;
      ...
      u_pox_y.real = this->pox_y;
      *(outbuffer + offset + 0) = (u_pox_y.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_pox_y.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_pox_y.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_pox_y.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->pox_y);
      union {
        float real;
        uint32_t base;
      } u_pos_z;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_pox_y.base = 0;
      u_pox_y.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_pox_y.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_pox_y.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_pox_y.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->pox_y = u_pox_y.real;
      offset += sizeof(this->pox_y);
      union {
        float real;
        uint32_t base;
    ...
    virtual const char * getType() override { return "robotic_sas_auv_ros/SetPoint"; };
    virtual const char * getMD5() override { return "1a5cf8fac147949090cf079711c45d1e"; };
