#ifndef _ROS_krsbi2025_NavigationSetting_h
#define _ROS_krsbi2025_NavigationSetting_h
...
namespace krsbi2025
{
  ...
  class NavigationSetting : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "krsbi2025/NavigationSetting"; };
