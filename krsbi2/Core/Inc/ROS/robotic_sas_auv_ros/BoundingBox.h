#ifndef _ROS_robotic_sas_auv_ros_BoundingBox_h
#define _ROS_robotic_sas_auv_ros_BoundingBox_h
...
namespace robotic_sas_auv_ros
{
  ...
  class BoundingBox : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robotic_sas_auv_ros/BoundingBox"; };
