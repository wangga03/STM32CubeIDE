// Generated by gencpp from file krsbi2025/Sensor.msg
// DO NOT EDIT!


#ifndef KRSBI2025_MESSAGE_SENSOR_H
#define KRSBI2025_MESSAGE_SENSOR_H
...
struct Sensor_
{
  ...
  typedef boost::shared_ptr< ::krsbi2025::Sensor_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::krsbi2025::Sensor_<ContainerAllocator> const> ConstPtr;

}; // struct Sensor_

typedef ::krsbi2025::Sensor_<std::allocator<void> > Sensor;

typedef boost::shared_ptr< ::krsbi2025::Sensor > SensorPtr;
typedef boost::shared_ptr< ::krsbi2025::Sensor const> SensorConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::krsbi2025::Sensor_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::krsbi2025::Sensor_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::krsbi2025::Sensor_<ContainerAllocator1> & lhs, const ::krsbi2025::Sensor_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::krsbi2025::Sensor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::krsbi2025::Sensor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::krsbi2025::Sensor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::krsbi2025::Sensor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::krsbi2025::Sensor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::krsbi2025::Sensor_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::krsbi2025::Sensor_<ContainerAllocator> >
{
  static const char* value()
  {
    return "563240a71b982d3350784e215714b923";
  }

  static const char* value(const ::krsbi2025::Sensor_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x563240a71b982d33ULL;
  static const uint64_t static_value2 = 0x50784e215714b923ULL;
};

template<class ContainerAllocator>
struct DataType< ::krsbi2025::Sensor_<ContainerAllocator> >
{
  static const char* value()
  {
    return "krsbi2025/Sensor";
  }
...
template<class ContainerAllocator>
struct Definition< ::krsbi2025::Sensor_<ContainerAllocator> >
{
  static const char* value()
  {
    return "float32 roll\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::krsbi2025::Sensor_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::krsbi2025::Sensor_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::krsbi2025::Sensor_<ContainerAllocator>& v)
  {
    s << indent << "roll: ";
...
#endif // KRSBI2025_MESSAGE_SENSOR_H
